    ...
    manifest: SERVICE_MANIFEST('ghcr.io/manifest-network/render-image-gen:dev', ['8000'], {
      env: {
        ...
        RENDER_INFERENCE_MODELS: JSON.stringify({
          ...
          'FLUX.1-schnell': { image: 'ghcr.io/manifest-network/render-image-gen-inference:flux-schnell', min_vram_gb: 32, max_vram_gb: 40 },
          'Kolors': { image: 'ghcr.io/manifest-network/render-image-gen-inference:kolors', min_vram_gb: 16, max_vram_gb: 24 },
          'SD 3.5 Large Turbo': { image: 'ghcr.io/manifest-network/render-image-gen-inference:sd35-large-turbo', min_vram_gb: 32, max_vram_gb: 40 },
        }),
      },
    }),
