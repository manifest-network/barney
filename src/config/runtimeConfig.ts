...
const BUILD_ENV: RuntimeConfig = {
  ...
  PUBLIC_FRED_COMPATIBILITY: import.meta.env.PUBLIC_FRED_COMPATIBILITY ?? '',
...
export const runtimeConfig: Readonly<RuntimeConfig> = Object.freeze({
  ...
  PUBLIC_FRED_COMPATIBILITY: getConfigValue('PUBLIC_FRED_COMPATIBILITY'),
